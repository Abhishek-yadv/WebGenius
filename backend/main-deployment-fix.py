...
# FastAPI App - Same as your working version
app = FastAPI(
...
# Extract links in DOM order (same as your working version)
...
# Extract main content from a page (same as your working version)
async def extract_content_from_page(page, url):
    try:
        ...
        # Use html.parser instead of lxml for deployment compatibility
...
# Scrape section with DOM-ordered results (same as your working version)
...
# API Routes - Same as your working version
@app.get("/")
async def root():
...
# Dev server entry - Same as your working version
